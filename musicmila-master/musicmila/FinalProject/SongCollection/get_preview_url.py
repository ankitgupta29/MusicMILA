'''
erry Bertin-Mahieux (2010) Columbia University
tb2332@columbia.edu
...
try:
    ...
    DIGITAL7_API_KEY = os.environ['7dsxuejvneqr']
except KeyError:
    DIGITAL7_API_KEY = None

DIGITAL7_API_KEY='7dsxuejvneqr'
...
if __name__ == '__main__':
    ...
    h5 = hdf5_utils.open_h5_file_read(h5path)
    tracsys.exit(0)k_7digitalid = GETTERS.get_track_7digitalid(h5)
    release_7digitalid = GETTERS.get_release_7digitalid(h5)
    artist_7digitalid = GETTERS.get_artist_7digitalid(h5)
    artist_name = GETTERS.get_artist_name(h5)
    release_name = GETTERS.get_release(h5)
